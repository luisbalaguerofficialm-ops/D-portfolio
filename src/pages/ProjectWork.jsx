...
const ProjectWork = () => {
  return (
    <div className="w-full bg-black text-white py-4">
      ...
      {/* Hero Title */}
      <div className="items-center justify-between mt-30 text-center">
        <h2 className=" text-[25px] text-medium  font-extrabold">
          "SECURITY-DRIVEN FULL-STACK SOFTWARE ENGINEER", <br /> "Full-Stack
            ...
            <div className="flex items-center gap-4 mt-6">
              <button className="group bg-lime-300 text-black px-6 py-2 rounded-full font-semibold hover:bg-lime-600 transition flex items-center">
                ...
                <img
                  ...
                  alt="circle"
                  className="
      w-8 h-8 ml-2 inline-block
      opacity-100 group-hover:opacity-0
      transition-opacity duration-300
    "
                />
                {/* Download image (hidden normally, visible on hover) */}
                <img
                  src={download}
                  alt="download"
                  className="
      w-8 h-8 ml-2 inline-block bg-[#000000]
      ...
      <section className="w-full text-white py-24 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div className="flex items-start text-center ">
            <h2 className="text-4xl  text-left md:text-6xl font-extrabold tracking-tight">
              "MY CAPABILITIES"
            </h2>
          </div>
