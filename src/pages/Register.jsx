...
import goodoo from "../assets/Google_2015_logo..png";

import img from "../assets/Daniel.jpg";
...
const Register = () => {
  ...
  return (
    <div className="min-h-[400px] flex flex-row lg:flex-row px-4 md:px-4">
      {/* LEFT SIDE */}
      <div className="flex-1 items-start flex flex-col justify-center px-6 py-10">
        <div className="mb-16 text-left text-green-600">
          <h2 className="font-bold text-6xl mb-3">You're welcome</h2>
          <p className="font-bold text-yellow-400 text-2xl">to view more projects kindly Sign Up..</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center gap-8 w-full max-w-[450px]">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 h-10 px-3 pr-10 border mb-2 bg-blue-500 border-blue-700 text-white rounded-lg"
            >
      ...
      <div className="hidden lg:flex flex-1 relative">
        ...
        <div className="absolute top-22 left-26 backdrop-blur-xs text-[#FFFFFF] p-4 text-[16px] leading-9 max-w-[400px] rounded-lg">
          <p className="font-bold text-3xl text-green-500">DANIEL...</p>
        </div>
      </div>
